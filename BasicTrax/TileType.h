...
namespace TileTypeLib
{
  ...
  // @param Edge of which the opposite should be returned
  ...
  public:
    ...
    // @param color at top edge of the tile
    ...
    // @param Color of left edge
    // @param Color of top edge
    // @param Color of right edge
    // @param Color of bottom edge
    //
